    ...
    layui.use(['laydate', 'layer', 'table', 'element'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'phone', width: 230, title: '注册手机号',align:'center',templet: '#phoneTpl'}
                , {field: 'edit_time', width: 300, title: '用户下单时间',align:'center',templet: '#edit_timeTpl'}
                , {field: 'remark', width: 300, title: '用户备注',align:'center',templet: '#remark'}
            ]]
            , id: 'testReload'
            , page: true
            , limit: 100
...
<script type="text/html" id="idTpl">
    ...
    <div class="layui-body">
        <div style="padding:5px 5px 0px 5px">
            <div class="layui-elem-quote">掌小龙订单管理</div>
            <form class="layui-form layui-form-pane">
                <div style="background-color: #f2f2f2;padding:5px 0">
                    <div class="layui-form-item" style="margin-bottom:5px">
                        ...
                        <label class="layui-form-label">注册人手机号</label>
                        <div class="layui-input-inline">
